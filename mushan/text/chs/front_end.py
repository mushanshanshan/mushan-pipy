...
from .ch_pho_sym import ch_symbols_dict
from .generate_lexicon import generate_lexicon
from .polyphonic import Polyphonic
from .xml_processor import MixTextProcessor
...
class Frontend():
    def __init__(self,
        ...
        self.vocab_phones = ch_symbols_dict
        self.vocab_tones = {}
        # if phone_vocab_path:
    ...
    def get_input_ids(self,
                      ...
                      blank_token: str="<pad>",
                      to_tensor: bool=True) -> Dict[str, List[torch.Tensor]]:
